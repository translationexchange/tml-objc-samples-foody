...
@interface APISerializer : NSCoder
/**
 *  Serializes object into JSON data. Usually for transmission to the API node.
 *
 *  @param object Any of NSNumber, NSString, NSArray, NSDictionary or Base
 *
...
/**
 *  Materializes JSON data into an object of given class. If class is omitted, APISerializes tries to guess.
